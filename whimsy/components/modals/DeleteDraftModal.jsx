...
import { deleteDraftFromCollection } from '../../services/firebaseDb';

const DeleteDraftModal = ({ navigation, onClose, storyId  }) => {
  ...
  const handleDeleteButtonPress = async () => {
    try {
      await deleteDraftFromCollection(storyId);
      ...
      {fontLoaded ? (
        <>
          <View style={styles.content}>
            ...
            <Text style={styles.body}>Once your draft is deleted, you won’t be able to retrieve it.</Text>
